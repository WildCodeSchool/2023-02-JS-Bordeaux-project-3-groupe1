...
(9, 6, 9, 1, 'Faire une photo ou une vidéo', 'GzgschJz8PU', NULL, 'Utiliser l\'application de l\'appareil photo pour prendre des photos et enregistrer des vidéos', 'Cela concerne l\'action de capturer des images fixes (photos) ou des séquences en mouvement (vidéos) à l\'aide de la caméra de votre téléphone'),
(10, 6, 10, 1, 'Partager une photo ou une vidéo', 'KhzYEpuTGNY', NULL, 'Comprendre les différentes options de partage, y compris les réseaux sociaux et les applications de messagerie', 'Il s\'agit de l\'action de partager des photos ou des vidéos prises avec votre téléphone avec d\'autres personnes via divers moyens tels que les réseaux sociaux, les messageries, les applications de partage de fichiers, etc'),
(11, 6, 11, 1, 'Écouter de la musique', 'nf7DMSXGW5Q', NULL, 'Utiliser l\'application de lecteur de musique pour écouter des chansons et des podcasts', 'Cela concerne l\'action d\'écouter des fichiers audio, tels que des chansons ou des podcasts, sur votre téléphone'),
(12, 6, 12, 1, 'Regarder des vidéos', 'VKjjWxnXBCw', NULL, 'Utiliser des applications vidéo pour regarder des vidéos en ligne et hors ligne', 'Cela fait référence à l\'action de visionner des vidéos sur votre téléphone, que ce soit des vidéos enregistrées localement, des vidéos en streaming ou des vidéos en ligne'),
(13, 6, 13, 1, 'Jouer', '0f5sh6TshFc', NULL, 'Jouer à des jeux : Découvrir et utiliser les fonctionnalités de jeu sur votre téléphone', 'Cela signifie jouer à des jeux sur votre téléphone, qu\'il s\'agisse de jeux intégrés, de jeux téléchargés à partir d\'une boutique d\'applications ou de jeux en ligne'),
(14, 6, 14, 1, 'Facebook', 'vCousHq5Usw', NULL, 'Présentation de Facebook', 'Facebook est un réseau social populaire où les utilisateurs peuvent se connecter avec des amis, partager des contenus tels que des photos et des vidéos, et interagir avec d\'autres utilisateurs via des publications, des commentaires, des messages'),
(15, 6, 15, 1, 'Instagram', 'hTryfrJuXRw', NULL, 'Présentation de Instagram', 'Instagram est une plateforme de partage de photos et de vidéos où les utilisateurs peuvent capturer, éditer et partager des contenus visuels avec leurs abonnés. Il propose également des fonctionnalités de messagerie et d\'interaction sociale'),
(16, 6, 16, 1, 'Tiktok', 'b7mlZQ9jAsY', NULL, 'Présentation de TikTok', 'TikTok est une application de médias sociaux axée sur le partage de courtes vidéos. Les utilisateurs peuvent créer, éditer et partager des vidéos de quelques secondes à une minute, accompagnées de musique, de filtres et d\'effets spéciaux'),
